...
\begin{frame}
	...
	\begin{column}{0.5\textwidth}
	\begin{tikzpicture}
	  	\node (img1) {\includegraphics[height=4cm]{Images/young_einstein.jpg}};
	  	\pause
		\node (img2) at (img1.south east) [xshift=1cm] {\includegraphics[height=4cm]{Images/nobel_einstein.png}};
	  	\pause
	  	\node (img3) at (img2.south west) [xshift=-1cm,yshift=1cm] {\includegraphics[height=4cm]{Images/old_einstein.jpg}};
	\end{tikzpicture}
	\end{column}
	\end{columns}
...
\begin{frame}
  \frametitle{Vacuum Energy}
  \framesubtitle{A solution to Dark Energy?}

  What could this all-pervading energy be?

  \begin{itemize}
    \pause\item Associated with empty space
    \pause\item Higgs Field/Higgs Boson?
    \pause\item Nope. Factor of $10^{120}$ too much energy in Higgs field.
  \end{itemize}
